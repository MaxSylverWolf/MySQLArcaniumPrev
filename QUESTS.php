...
echo '<center>';
echo "<table>";
echo "<tr><th>Table name: QUESTS</th></tr>";
echo "</table>";
...
echo  "<a  href=createQUESTS.html><img src=CREATE.png  /></a>";
echo  "<a  href=readQUESTS.php><img src=READ.png  /></a>";
echo  "<a  href=editQUESTS.html><img src=UPDATE.png  /></a>";
echo  "<a  href=deleteQUESTS.html><img src=DELETE.png  /></a>";
