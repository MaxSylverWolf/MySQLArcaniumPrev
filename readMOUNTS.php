...
echo '<center>';
echo "<table>";
echo "<tr><th>Table name: MOUNTS</th></tr>";
echo "</table>";
...
if($conn->connect_error)
 {
  ...
  while($row = $result->fetch_assoc()) {
    ...
    "<tr>";
	  ...
	  <td>" . $row["mountname"]. "</td>
	  <td>" . $row["id_skill"]. "</td>
	  <td>" . $row["mountdefence"]. "</td>
	  <td>" . $row["mountattack"]. "</td>";  
	  echo "</tr>";
	}
echo "</table>";
}
...
echo  "<a  href=createMOUNTS.html><img src=CREATE.png  /></a>";
echo  "<a  href=readMOUNTS.php><img src=READ.png  /></a>";
echo  "<a  href=editMOUNTS.html><img src=UPDATE.png  /></a>";
echo  "<a  href=deleteMOUNTS.html><img src=DELETE.png  /></a>";
