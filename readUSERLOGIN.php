...
echo '<center>';
echo "<table>";
echo "<tr><th>Table name: USERLOGIN</th></tr>";
echo "</table>";
...
if($conn->connect_error)
 {
  ...
  {
  $sql = "SELECT * FROM USERLOGIN where id = id_char";
...
echo  "<a  href=createUSERLOGIN.html><img src=CREATE.png  /></a>";
echo  "<a  href=readUSERLOGIN.php><img src=READ.png  /></a>";
echo  "<a  href=editUSERLOGIN.html><img src=UPDATE.png  /></a>";
echo  "<a  href=deleteUSERLOGIN.html><img src=DELETE.png  /></a>";
