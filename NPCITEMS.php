...
echo '<center>';
echo "<table>";
echo "<tr><th>Table name: NPCITEMS</th></tr>";
echo "</table>";
...
echo  "<a  href=createNPCITEMS.html><img src=CREATE.png  /></a>";
echo  "<a  href=readNPCITEMS.php><img src=READ.png  /></a>";
echo  "<a  href=editNPCITEMS.html><img src=UPDATE.png  /></a>";
echo  "<a  href=deleteNPCITEMS.html><img src=DELETE.png  /></a>";
