...
echo '<center>';
echo "<table>";
echo "<tr><th>Table name: SKILLS</th></tr>";
echo "</table>";
...
if($conn->connect_error)
 {
  ...
  while($row = $result->fetch_assoc()) {
    ...
    "<tr>";
      ...
      "<td>" . $row["id_skill"]. "</td> 	  
      <td>" . $row["skill"]. "</td> 	
      <td>" . $row["skill_attack"]. "</td> 
	  <td>" . $row["skill_buff"]. "</td>"; 
	  echo "</tr>";
	}
echo "</table>";
}
...
echo  "<a  href=createSKILLS.html><img src=CREATE.png  /></a>";
echo  "<a  href=readSKILLS.php><img src=READ.png  /></a>";
echo  "<a  href=editSKILLS.html><img src=UPDATE.png  /></a>";
echo  "<a  href=deleteSKILLS.html><img src=DELETE.png  /></a>";
