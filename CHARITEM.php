...
echo '<center>';
echo "<table>";
echo "<tr><th>Table name: CHARITEM</th></tr>";
echo "</table>";
...
echo  "<a  href=createCHARITEM.html><img src=CREATE.png  /></a>";
echo  "<a  href=readCHARITEM.php><img src=READ.png  /></a>";
echo  "<a  href=editCHARITEM.html><img src=UPDATE.png  /></a>";
echo  "<a  href=deleteCHARITEM.html><img src=DELETE.png  /></a>";
