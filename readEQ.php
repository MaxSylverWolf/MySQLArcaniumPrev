...
echo '<center>';
echo "<table>";
echo "<tr><th>Table name: EQ</th></tr>";
echo "</table>";
...
if($conn->connect_error)
 {
  ...
  {
  $sql = "SELECT * FROM EQ where id_eq = id_char";
...
echo  "<a  href=createEQ.html><img src=CREATE.png  /></a>";
echo  "<a  href=readEQ.php><img src=READ.png  /></a>";
echo  "<a  href=editEQ.html><img src=UPDATE.png  /></a>";
echo  "<a  href=deleteEQ.html><img src=DELETE.png  /></a>";
