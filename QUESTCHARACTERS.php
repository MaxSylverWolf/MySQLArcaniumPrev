...
echo '<center>';
echo "<table>";
echo "<tr><th>Table name: QUESTCHARACTERS</th></tr>";
echo "</table>";
...
if($conn->connect_error)
 {
  ...
  {
  $sql = "SELECT * FROM QUESTCHARACTERS";
...
echo  "<a  href=createQUESTCHARACTERS.html><img src=CREATE.png  /></a>";
echo  "<a  href=readQUESTCHARACTERS.php><img src=READ.png  /></a>";
echo  "<a  href=editQUESTCHARACTERS.html><img src=UPDATE.png  /></a>";
echo  "<a  href=deleteQUESTCHARACTERS.html><img src=DELETE.png  /></a>";
